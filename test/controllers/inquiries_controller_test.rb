...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { content: @inquiry.content, email: @inquiry.email, name: @inquiry.name } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { content: @inquiry.content, email: @inquiry.email, name: @inquiry.name } }
